...
export default function EmployeeHierarchyAssignmentEdit() {
  ...
  useEffect(() => {
    ...
    setEffectiveFrom(
      assignment.effective_from
        ? assignment.effective_from.substring(
            0,
            10
          )
        : ''
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(
        'Employee hierarchy assignment updated successfully'
      );
      ...
      toast.error(
        error?.data?.message ||
        'Hierarchy assignment update failed'
      );
    }
  };
    ...
    return (
      <DashboardContent>
        ...
        <Typography color="error">
          Failed to load employee hierarchy assignment.
        </Typography>
  ...
  return (
    <DashboardContent>
      ...
      <Typography
        ...
        sx={{ mb: 3 }}
      >
        Edit Employee Hierarchy Assignment
      </Typography>
